...
public class SuperQueue {
    ...
    public void disconnect(int nextMessage) {
        ...
        try {
            ...
            for(Message m: messages.subList(from, to)) {
                m.consume();
            }
    ...
    public void write(String message) {
        ...
        try {
            ...
            messages.add(new Message(message, clients));
            counter++;
    ...
    public String read(int messageId) throws InterruptedException, MessageDeletedException {
        lock.lock();
        try {
