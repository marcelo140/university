...
(* Why3 assumption *)
Fixpoint elem {a:Type} {a_WT:WhyType a} (x:a)
  (l:(list a)) {struct l}: Prop :=
  match l with
  | Init.Datatypes.nil => False
  | (Init.Datatypes.cons h t) => (x = h) \/ (elem x t)
  end.

(* Why3 goal *)
Theorem in_app : forall {a:Type} {a_WT:WhyType a}, forall (x:a) (l1:(list a))
