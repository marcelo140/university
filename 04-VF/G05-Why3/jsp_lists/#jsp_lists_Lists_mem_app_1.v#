...
(* Why3 goal *)
Theorem mem_app : forall {a:Type} {a_WT:WhyType a}, forall (x:a)
  (l1:(list a)) (l2:(list a)), (list.Mem.mem x (infix_plpl l1 l2)) ->
  ((list.Mem.mem x l1) \/ (list.Mem.mem x l2)).
(* Why3 intros a a_WT x l1 l2 h1. *)
intros a a_WT x l1 l2 h1.
induction l1.
...
*)
(*
induction l1; simpl in h1; simpl; intuition.
*)
Qed.
