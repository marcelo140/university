...
Axiom assign_rule : forall (q:fmla) (x:ident) (e:expr), (valid_triple
...
(* Why3 goal *)
Theorem while_rule : forall (e:expr) (inv:fmla) (i:stmt), (valid_triple
  (Fand (Fterm e) inv) i inv) -> (valid_triple inv (Swhile e i)
  (Fand (Fnot (Fterm e)) inv)).
(* Why3 intros e inv i h1. *)
Proof.
unfold valid_triple.
